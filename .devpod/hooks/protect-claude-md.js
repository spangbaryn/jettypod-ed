#!/usr/bin/env node
// Prototype: Enforce devpod command usage - Balanced (Claude Code Protocol)
// Created: 2025-10-16
// Purpose: PreToolUse hook that blocks direct CLAUDE.md edits and suggests devpod commands
 ...
 *           {
 *             "type": "command",
 *             "command": "./prototypes/2025-10-16-enforce-devpod-balanced-v2.js"
 *           }
 *         ]
 *       },
 *       {
...
const FORBIDDEN_PATTERNS = [
  ...
  },
  {
    ...
    suggestion: (old, newStr) => {
      ...
      if (workId) {
        return `Use: devpod work start ${workId}`;
      }
      return 'Use: devpod work start <id> or devpod work stop';
    }
  },
  {
    ...
    suggestion: (old, newStr) => {
      ...
      if (workId && newStatus) {
        return `Use: devpod work status ${workId} ${newStatus}`;
      }
      return 'Use: devpod work status <id> <status>';
    }
  },
  {
    name: 'stage_change',
    ...
    suggestion: (old, newStr) => {
      ...
      return `Use: devpod stage ${newStage}`;
    }
  }
];
...
/**
 * Test cases (run with: node prototypes/2025-10-16-enforce-devpod-balanced-v2.js test)
 */
